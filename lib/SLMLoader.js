...
function loadSubZip2 (back,meshIndex){
	// var url="localhost:8081/dist/"+"assets/models/huayi/"+meshIndex+".zip"
	// new Network().myRequest(
	// 	url,
	// 	(unityArray,blob)=>{
	// 		console.log("finish:",meshIndex)
	// 		console.log("unityArray",unityArray)
...
// import { LoadModel } from './zip_test.js';
// new LoadModel({
// 	// url:"localhost:8081/dist/"+"assets/models/huayi/0.zip"
// 	url:"assets/models/huayi/0.zip"
// })
function loadSubZip3 (back,meshIndex){
	var worker=new Worker("./myWorker/loadSubZip.js")
	worker.onmessage=ev=>{
		console.log(ev.data)
		console.log(ev.data.myArray)
		// var loader=new LoadingManager()
		// loader.setURLModifier( zip.urlResolver );//装载资源
