...
// import { DataParse } from './myThree/DataParse';
...
var SLMSceneBuilder = function(sceneMgr, options)
{
	...
	function InstanceNode(gltfScene, iMatrix, structDesc)//找出
	{
		...
		function loading(meshIndex) {//普通加载
			...
			// 		loadSubZip(addModel2,meshIndex,
			// 			matrixConfig,structdesc0
			// 		)
			// 	}
			// )
		...
		// function loading2(meshIndex){
		// 	if(!window.loadedLZC)window.loadedLZC={}
		// 	if(window.loadedLZC[meshIndex]) return;
		// 	else window.loadedLZC[meshIndex]=1;

		// 	var w=new Worker("./myThree/DataParse.js")
		// 	//希望直接获取m2但是失败了
		// 	// w.onmessage = function(ev) {
        //     //     // console.log(ev.data)
		// 	// 	console.log("!!!!!!!!!!!!!!!!")
		// 	// 	var g=ev.data.geometry
		// 	// 	var geometry2=new BufferGeometryEx()
		...
		// 	// 	geometry2.index=new BufferAttribute()
		// 	// 	console.log(g,"ev.data.geometry")
		// 	// 	for(var i1 in g){
		// 	// 		var o1=g[i1]
		// 	// 		if(typeof(o1)==="object" && i1!=="groups" ){
		// 	// 			for(var i2 in o1){
		// 	// 				var o2=o1[i2]
		// 	// 				// console.log(typeof(o2))
		// 	// 				if(typeof(o2)==="object" && i2!=="array"){
		// 	// 					// console.log("need o3")
		// 	// 					for(var i3 in o2){
		// 	// 						var o3=o2[i3]
		// 	// 						if(typeof(o3)==="object"&&i3!=="array"){
		// 	// 							for(var i4 in o3){
		// 	// 								var o4=o3[i4]
		// 	// 								if(typeof(o4)==="object"){
		// 	// 									console.log("need o5",o4,i1,i2,i3,i4)
		// 	// 									alert("o5")
		// 	// 								}else{
		// 	// 									console.log(
		// 	// 										i1+"."+i2+"."+i3+"."+i4,
		// 	// 										g[i1][i2][i3][i4]
		// 	// 										)
		// 	// 										if(!geometry2[i1][i2][i3])geometry2[i1][i2][i3]={}
		// 	// 										geometry2[i1][i2][i3][i4]=g[i1][i2][i3][i4]
		// 	// 								}
		// 	// 							}
		// 	// 						}else{
		// 	// 							console.log(i1+"."+i2+"."+i3,g[i1][i2][i3])
		// 	// 							if(!geometry2[i1])geometry2[i1]={}
		// 	// 							if(!geometry2[i1][i2])geometry2[i1][i2]={}
		// 	// 							geometry2[i1][i2][i3]=g[i1][i2][i3]
		// 	// 						}
		// 	// 					}

		// 	// 				}else{
		// 	// 					console.log(i1+"."+i2,g[i1][i2])
		// 	// 					if(!geometry2[i1])geometry2[i1]={}
		// 	// 					geometry2[i1][i2]=g[i1][i2]
		// 	// 				}
		// 	// 			}
		// 	// 		}else{
		// 	// 			console.log(i1,g[i1])
		...
		// 	// 	// var geometry2=new BufferGeometryEx()
		// 	// 	// for(var i in ev.data.geometry){
		// 	// 	// 	geometry2[i]=ev.data.geometry[i]
		// 	// 	// }

		// 	// 	geometry2=geometry2.clone()
		// 	// 	var m2=new InstancedMeshEx(
		// 	// 		geometry2,//ev.data.geometry,
		// 	// 		[
		// 	// 			new MeshStandardMaterial({color:ev.data.color})
		// 	// 		], 
		// 	// 		1, 
		// 	// 		ev.data.instanceCountList, 
		// 	// 		false
		// 	// 	)
		// 	// 	// console.log("还原生成的m2:",m2)
		// 	// 	// instanceRoot.add(m2);
		// 	// 	window.meshes[meshIndex]=m2;
		// 	// 	console.log("多线程 addModel",meshIndex)
		...
		// 		// console.log("还原生成的m1:",m1)
		// 		// instanceRoot.add(m1);
		// 		var m2=processMesh(
		// 			m1, //mesh
		// 			ev.data.structdesc0,//实例化的矩阵？
		// 			ev.data.matrixConfig,
		// 			m1.matrix,
		// 			slmSceneMeta //处理器？
		// 		)	
		...
		// window.addMoment("loadJson start")
		// loadJson("assets/models/6.ls_d.json",(data)=>{
		// 	window.addMoment("loadJson end")
		// 	new DynamicLoading({"loading":loading,"data_test":data})
		// })
...
function loadSubZip2 (back,meshIndex){
	...
	new ZipLoader()
		...
		.then( 
				zip=>{	
					var loadingManager = new LoadingManager();//必须放在这
					loadingManager.setURLModifier( zip.urlResolver );//必须放在这
					var loader = new FileLoader(loadingManager);
					loader.load(
						zip.find( /\.(json)$/i )[0] , 
						data0=>{
