...
function addModel2(m1,meshIndex,matrixConfig,structdesc0){
    ...
    postMessage({
        ...
        "geometry_attributes":m2.geometry.attributes,
        "geometry_groups":m2.geometry.groups,

        "cololr":m2.material[0].color,
        "meshIndex":meshIndex,
        "geometry":m2.geometry,
        "instanceCountList":m2.instanceCountList,
    })
